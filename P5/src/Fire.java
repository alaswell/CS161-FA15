...
public class Fire extends Flow {
	...
	public Fire(int nRows, int nColumns, int startR, int startC, double initialAmount) 
	{
		super("Fire", 0.5, startR, startC, initialAmount, nRows, nColumns, 1.0, 0.1, 0.1);
	...
	public static void main(String[] args) 
	{
		...
		{
			System.out.println(Arrays.deepToString(f.getAmount()));
			f.update(elevation);
		}	
	}
}
